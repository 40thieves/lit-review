...
Scientific publishing has grown to an incredible rate, with over 800 000 papers published in 2008 in PubMed alone. Neylon and Wu claim this growth has overwhelming for research - "It [is] impossible for any scientist to read every paper relevant to their research, and a difficult choice has to be made about which papers to read" [Article Level Metrics and the Evolution of Scientific Impact; Neylon & Wu; 2009]. The authors of the altmetrics manifesto argue that the traditional forms of filtering research output, namely the impact factor, are failing as they are too narrow, too slow and not designed for the scale of current research output.
