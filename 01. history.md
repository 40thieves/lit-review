...
* Only measures citations to articles
	* Doesn't measure other forms of scholarly communication
		* Blogs, twitter
	* Doesn't capture the "scientific street cred"
* Doesn't measure impact of other important academic outputs
	* Data sets
	* Code
...
Other areas of scholarly work are also overlooked by the impact factor. The published paper is not necessarily the total output of a researcher, although it is often used to summarise. Additional work might include data sets, or code written, that may go on to be reused by further research, increasing it's impact. However this potential impact will be not be captured by the impact factor.

Additionally, some forms of scholarly communication that were rarely recorded before are now becoming commonplace in digital formats. Researchers who collaborate well, or can explain concepts well have unpublished, but still valuable impact.  Again, the impact factor does not take this into consideration.
